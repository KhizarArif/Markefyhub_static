      ...
      <section className="flex flex-col md:flex-row items-center max-w-7xl w-full px-4 py-16 mx-auto gap-10">
        <div className="flex-1 space-y-6 max-w-[450px]">
          ...
          <p className="text-black leading-relaxed text-xl w-[50vw]">
            Whether you&apos;re looking for information, support, or partnership
            opportunities, we&apos;re all ears. Drop us a message and let’s
            start the conversation today. Together, we can make something
            amazing happen!
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="flex-1 bg-white p-8 rounded-lg shadow-sm">
              <h3 className="text-lg font-semibold text-[#2C35A5] mb-2">
                Send Us Message
              </h3>
