...
const CB = () => {
    ...
    return (
        <main className="flex flex-col items-center w-full">
          <HeroBanner title='CMS Development'/>
            <ServiceSecond services={Services}/>

            <section className="w-full py-16 ">
                <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center mt-16 bg-[background: #FAFAFA]">
                    {/* Left Image */}
                    <div className="flex justify-center">
                        <Image src="/cms.png" alt="megaphone" width={400} height={400} className="object-contain " />
                    </div>
